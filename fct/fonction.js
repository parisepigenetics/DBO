...
$(document).ready(function() {
    ...
    if (verif === null) alert("Adapter wrong content!")
    else
    if (verif1 === null) alert("RNA sequence wrong content!")
    else  {
    ...
    if (taille !== veriftail ) alert("Adapter wrong content!")
        ...
        var mapObj = {A:"T",C:"G",G:"C",T:"A"};
            ...
            var mapObj1 = {A:"T",C:"G",G:"C",T:"A"};
                    ...
                    RNA_pre= seqq.replace(re, function(matched){
        ...
        document.getElementById("oligo_seq").value= RNA_order
    };
    } 
    });
    ...
    $(".add").click(function() {
        ...
        var confirmation = confirm("There is no oligo name. Are you sure to continue?");
                    ...
                    var ligne = "<tr><td><input type='checkbox' name='select'></td><td>" + nom + "</td><td>" + sequence + "</td></tr>";
